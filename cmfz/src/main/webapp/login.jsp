				...
				<table>
					<tbody>
						<tr>
							...
							<td>
								<input type="text"  name="name" class="text" value="" maxlength="20" id="nameid"/>
							</td>
					  </tr>
					  <tr>
							<th>
							...
							<td>
								<input type="password" name="password" class="text" value="" maxlength="20" autocomplete="off" id="pwdid"/>
							</td>
					  </tr>
						...
						<tr>
							...
							<td>
								...
								<img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/defaultKaptcha" title="点击更换验证码"
									 onclick="document.getElementById('captchaImage').src='${pageContext.request.contextPath}/defaultKaptcha?time='+(new Date()).getTime();"/>
							</td>
						</tr>					
					<tr>
						<td>
